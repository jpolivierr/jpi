...
public class CliLauncher {
    ...
    private void run() {
        ...
        CliContext cliContext = CliContext.getInstance();
        cliContext.registerBean(CliConfig.class, cliConfig);
        cliContext.registerBean(WorkspaceTemplate.class, workspaceTemplate);
        cliContext.registerBean(ActiveProjectDetails.class, activeProjectDetails);
    }
